...
module.exports = {
    ...
    create: async (req, res) => {
        ...
        if (checkStudent) return res.status(400).json({ message: 'Student already exists' }); // if student already exists, return 400 with error message
    ...
    update: async (req, res) => {
        ...
        if (!checkStudent) return res.status(400).json({ message: 'Student does not exist' });
